              ...
              {showProfileMenu && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center space-x-2 px-3 py-2 rounded-xl text-xs font-semibold text-teal-400 hover:bg-teal-500/10 transition-colors mb-1 cursor-pointer"
                  >
